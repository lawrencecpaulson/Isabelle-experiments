...
However, they provide the crucial link between type \isa{V} and other Isabelle/HOL types. They allow us to combine set theory and complex analysis. For example, the check that some entity is small (representable by a ZF set) is usually automatic, thanks to this type class setup.
